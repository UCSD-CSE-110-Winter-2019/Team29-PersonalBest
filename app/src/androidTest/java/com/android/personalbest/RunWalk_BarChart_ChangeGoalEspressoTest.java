...
public class RunWalk_BarChart_ChangeGoalEspressoTest {
    ...
    public void runWalk_BarChart_ChangeGoalEspressoTest() {
        ...
        ViewInteraction appCompatButton4 = onView(
                allOf(withId(R.id.startButton), withText("Start Run"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatRadioButton2 = onView(
                allOf(withId(R.id.walkerOption), withText("Walker"),
                        childAtPosition(
                                allOf(withId(R.id.radioChoices),
                                        childAtPosition(
                                                withClassName(is("android.support.constraint.ConstraintLayout")),
        ...
        ViewInteraction appCompatButton8 = onView(
                allOf(withId(R.id.startButton), withText("Start Walk"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatButton9 = onView(
                allOf(withId(R.id.endButton), withText("End Walk"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatButton11 = onView(
                allOf(withId(R.id.changeGoal), withText("Change Goal"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction editText2 = onView(
                allOf(withText("1"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        editText2.perform(replaceText("100"));
        ...
        ViewInteraction editText4 = onView(
                allOf(withText("100"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        editText4.perform(replaceText("1000"));
        ...
        ViewInteraction appCompatButton14 = onView(
                allOf(withId(R.id.seeBarChart), withText("See Bar Chart"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
